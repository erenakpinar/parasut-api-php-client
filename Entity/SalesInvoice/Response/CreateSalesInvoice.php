...
class CreateSalesInvoice
{
     ...
     * @param mixed $sharing
     */
    public function addSharing($sharing)
    {
    ...
    /**
     * @param mixed $recurrence_plan
     */
    public function setRecurrencePlan($recurrence_plan)
    {
    ...
    /**
     * @param mixed $active_e_document
     */
    public function setActiveEDocument($active_e_document)
    {
